defmodule Coinex.FeeCalculationDetailedTest do
  ...
  alias Coinex.FuturesExchange.{ActionCalculator, Balance, Order}
  ...
  describe "Detailed Fee Calculation in calculate_action_effect" do
    test "verifies exact taker fee calculation (0.05%) with different order values" do
      ...
      {result1, _} =
        ActionCalculator.calculate_action_effect(
          balance1,
          %{},
          {:fill_order, market_order1, Decimal.new("50000")}
        )
      ...
      {result2, _} =
        ActionCalculator.calculate_action_effect(
          balance2,
          %{},
          {:fill_order, market_order2, Decimal.new("50000")}
        )
      ...
      {result3, _} =
        ActionCalculator.calculate_action_effect(
          balance3,
          %{},
          {:fill_order, market_order3, Decimal.new("72000")}
        )
    ...
    test "verifies exact maker fee calculation (0.03%) with different order values" do
      ...
      {result1, _} =
        ActionCalculator.calculate_action_effect(
          balance1,
          %{},
          {:fill_order, limit_order1, Decimal.new("50000")}
        )
      ...
      {result2, _} =
        ActionCalculator.calculate_action_effect(
          balance2,
          %{},
          {:fill_order, limit_order2, Decimal.new("50000")}
        )
    ...
    test "verifies cumulative fee calculation across multiple orders" do
      initial_balance = %Balance{
        ...
        total: Decimal.new("10000"),
        unrealized_pnl: Decimal.new("0"),
        # Starting with existing fees
        total_fees_paid: Decimal.new("1.5")
      }
      ...
      {balance_final, _} =
        ActionCalculator.calculate_action_effect(
          ...
          {:fill_order, limit_order, Decimal.new("52000")}
        )
    ...
    test "verifies fee calculation with decimal precision" do
      ...
      precise_order = %Order{
        ...
        type: "market",
        # Precise amount
        amount: Decimal.new("0.00123456"),
        # Precise price
        price: Decimal.new("45678.9876"),
      ...
      {result, _} =
        ActionCalculator.calculate_action_effect(
          balance,
          %{},
          {:fill_order, precise_order, fill_price}
        )
